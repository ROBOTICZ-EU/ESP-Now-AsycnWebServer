///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//                       Version 2.8 "Rain_Gauge.ino"  06/23/2020 @ 13:42 EDT Developed by William  M. Lucid, techno500
//                       Licensed under GNU GPL v3.0, https://www.gnu.org/licenses/gpl.html
//
//                       C:\Users\1234\Desktop\■■ ESP-Now --Santos\Rain_Gauge_Build1
//
...
float fahren = incomingReadings.temp;
float humd = incomingReadings.hum;
float currentPressure = incomingReadings.press;



JSONVar board;

AsyncWebServer serverAsynctwo(80);
...
void OnDataRecv(const uint8_t * mac_addr, const uint8_t *incomingData, int len) {
  ...
  event.send(jsonString.c_str(), "new_readings", millis());
...
if (!!window.EventSource) {
 ...
 source.addEventListener('new_readings', function(e) {
  ...
  document.getElementById("p"+obj.id).innerHTML = obj.press.toFixed(2);
  document.getElementById("rt"+obj.id).innerHTML = obj.readingId;
  document.getElementById("rh"+obj.id).innerHTML = obj.readingId;  //-----------------------is this neccessary?-----------------
 }, false);
 }
</script>
</body>
...
void setup(void)
{
  ...
  Serial.println("");
  Serial.println("Version 2.8 'Rain_Gauge.ino'  06/23/2020 @ 13:42 EDT");
  ...
  serverAsync.addHandler(&events);   //-----------change server to serverAsync------------------
  //server.begin();
...
void speak()
{
  ...
  char t_buffered1[14];
  dtostrf(fahren, 7, 1, t_buffered1);
...
void webInterface()
{
  ...
  dtostrf(fahren, 6, 1, fahr); // Leave room for too large numbers!
  ...
  dtostrf(gpsalt, 8, 1, alt); // Leave room for too large numbers!
