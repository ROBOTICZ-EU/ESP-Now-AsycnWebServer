...
//
//                       https://observations-weather.000webhostapp.com/index.php  Served from Free Domain, hosting powered by "Hostinger."
//
//
...
#include <esp_now.h>   //Part of version 1.0.4 ESP32 Board Manager install
...
void webInterface()
{
  ...
  if (WiFi.status() == WL_CONNECTED)
  {
    ...
    http.begin(sendData);      //Specify URL request destination
